...
- `/create_deck <название>` — создаёт новую колоду карточек. Новая колода автоматически становится активной.
- `/list_decks` — показывает список всех ваших колод с количеством карточек и карточек к повторению. Отмечает активную колоду.
- `/select_deck <ID>` — устанавливает колоду как активную. Все новые карточки через `/add` будут добавляться в эту колоду.
- `/delete_deck <ID>` — удаляет колоду и все её карточки.
